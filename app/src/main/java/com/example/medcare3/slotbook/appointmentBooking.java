package com.example.medcare3.slotbook;
...
import com.example.medcare3.HomeActivity;
//import com.example.medcare3.Home_NavigationActivity;
import com.example.medcare3.R;
...
//    DatabaseReference root =mydb.getReference().child("Appointments");
...
*/
    ...
    private void book() {
       ...
       // String time = inputtime.getText().toString();
        ...
        //Firebase set value when clicked
    ...
    private void WriteData(final String name, final String phno, final String dob , final String time , final String date) {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(!(dataSnapshot.child("Appointments").child(date).child(time).exists())){
                    ...
                    RootRef.push().setValue(userdataMap);

                    RootRef.child("Appointments").child(date).child(time).updateChildren(userdataMap)
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful())
                                    {
                                        ...
                                        Intent intent = new Intent(appointmentBooking.this, HomeActivity.class);
                                        startActivity(intent);
                                        finish();
                                        notifications();
